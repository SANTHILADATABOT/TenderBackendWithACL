...
class NewsubmenuCreationSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $submenuid = sub_module_menu::create(['user_role_id'=>1, 'parentModuleID'=>1, 'sorting_order'=>'18','name'=>'attendance_type','menuLink'=>'/tender/hr/attendancetype','aliasName'=>'Attendance Type Master','status'=>'1', 'createdby'=>'1' ]);
